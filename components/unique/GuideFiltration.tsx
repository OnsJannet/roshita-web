...
const GuideFiltration: React.FC<GuideFiltrationProps> = ({ onSearchChange, onCountryChange, onSpecialtyChange }) => {
  ...
  const [selectedFilter, setSelectedFilter] = useState<string | null>(null); // Add state for selected filter
    ...
    <div className="lg:-mt-[80px] xl:-mt-[40px] mt-[180px] rounded-2xl p-6 max-w-[1280px] mx-auto relative" style={{ zIndex: 9999 }}>
      <div className="!bg-white justify-center flex lg:flex-row-reverse flex-col rounded-lg p-4" style={{ boxShadow: "0 8px 26.6px rgba(0, 0, 0, 0.09)" }}>
        <div
          ...
          className={`lg:border-l-gray-200 border-b-gray-200 lg:border-b-transparent lg:border-l border-b p-4 flex justify-center items-center flex-row-reverse lg:w-[25%] w-full cursor-pointer ${selectedFilter === 'doctorsSearch' ? 'bg-roshitaDarkBlue text-white rounded-lg' : ''}`}
        >
        ...
        <div
          ...
          className={`lg:border-l-gray-200 border-b-gray-200 lg:border-l lg:border-b-transparent border-b p-4 flex justify-center items-center flex-row-reverse lg:w-[25%] w-full cursor-pointer ${selectedFilter === 'hospitalsSearch' ? 'bg-roshitaDarkBlue text-white rounded-lg' : ''}`}
        >
        ...
        <div
          ...
          className={`lg:border-l-gray-200 border-b-gray-200 lg:border-l lg:border-b-transparent border-b p-4 flex justify-center items-center flex-row-reverse lg:w-[25%] w-full cursor-pointer ${selectedFilter === 'pharmaciesSearch' ? 'bg-roshitaDarkBlue text-white rounded-lg' : ''}`}
        >
        ...
        <div
          ...
          className={`p-4 flex justify-center items-center flex-row-reverse lg:border-b-transparent lg:w-[25%] w-full cursor-pointer ${selectedFilter === 'labs' ? 'bg-roshitaDarkBlue text-white rounded-lg' : ''}`}
        >
