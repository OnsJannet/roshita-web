...
const Filters = () => {
  ...
  const handleSearch = () => {
    if (selectedCountry && selectedSpecialty) {
      window.location.href=`/doctor-appointement/${encodeURIComponent(selectedCountry)}/${encodeURIComponent(selectedSpecialty)}`;
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between gap-4">
        <Button variant="register" className="rounded-xl h-[52px] w-[440px] gap-1 font-bold" onClick={handleSearch}>
          بحث
