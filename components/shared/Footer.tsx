    ...
    <footer className='bg-[#F2F7FF] p-4'>
      <div className='flex flex-col justify-center max-w-[1280px] mx-auto py-8'>
        ...
        <p className='mx-auto mt-6'>
          {language === "ar" ? `${CurrentYear} الحقوق محفوظة لمنصة روشيتا©` : `© ${CurrentYear} All rights reserved by Roshita`}
        </p>
        <div className='mt-6 flex gap-4 justify-center mx-auto'>
          <img src='/logos/applestore.png' alt='App Store' className='w-[200px] h-14 mx-auto' />
          <img src='/logos/googleplay.png' alt='Google Play' className='w-[200px] h-14 mx-auto' />
        </div>
        <div className='flex justify-center w-[20%] mx-auto mt-4 gap-4'>
          <img src='/logos/facebooklogo.png' alt='Facebook' className='w-[15px] h-[25px] cursor-pointer' />
          <img src='/logos/iglogo.png' alt='Instagram' className='w-6 h-6 cursor-pointer' />
          <img src='/logos/whatsapplogo.png' alt='WhatsApp' className='w-6 h-6 cursor-pointer' />
          <img src='/logos/linkedinlogo.png' alt='LinkedIn' className='w-6 h-6 cursor-pointer' />
          <img src='/logos/messengerlogo.png' alt='Messenger' className='w-6 h-6 cursor-pointer' />
          <img src='/logos/tiktoklogo.png' alt='TikTok' className='w-6 h-6 cursor-pointer' />
        </div>
      </div>
    </footer>
  );
