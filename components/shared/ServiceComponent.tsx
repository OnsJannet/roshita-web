  ...
  const content: LanguageContent = {
    ar: {
      ...
      services: [
          ...
          description: 'قبل الحجز هذه الشفافية تمنح الـــــمستخدمـــــــين الثقة وتخفّف من القلق تجاه الاخــــــتيار الطبي، مما يمكّنهم من اتخاذ قرار واثق مبنيّ على تجارب حقيقية.'
        },
        {
          title: 'مقــــــــارنة عادلة بين الجودة والسعر',
          description: 'توفر هذه المنصة للمستخدم رحلة سلسة بدون الحاجة للانتقال المتكرر، فتوفّر الوقت والجهد وتعزز الاعتماد على الخدمات الرقمية بعد توسعها في تونس وليبيا .'
        },
        {
