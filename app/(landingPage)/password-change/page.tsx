...
import { Camera, Lock, LogOut, Mail, MapPin, MonitorCheck, Phone, Settings, UserRound, Eye, EyeOff } from "lucide-react";
...
const PasswordChange = () => {
    ...
    const [passwordCheckVisible, setPasswordCheckVisible] = useState<boolean>(false);
                    ...
                    <div className="flex gap-10 text-end flex-col w-[80%] mx-auto">
                        <div>
                            ...
                            <div className="flex gap-2 flex-row-reverse items-center rounded-lg bg-white border px-4 mt-2 border-none text-start">
                                ...
                                >
                                    {passwordVisible ? <EyeOff className="text-roshitaDarkBlue" /> : <Eye className="text-roshitaDarkBlue" />}
                                </button>
                            </div>
                        </div>
                        <div>
                        <Label className="text-start">كلمة المرور الجديدة</Label>
                            <div className="flex gap-2 flex-row-reverse items-center rounded-lg bg-white border px-4 mt-2 border-none text-start">
                                ...
                                >
                                    {passwordCheckVisible ? <EyeOff className="text-roshitaDarkBlue" /> : <Eye className="text-roshitaDarkBlue" />}
                                </button>
                            </div>
                        </div>
                        <Button onClick={handleSave} className="text-white bg-roshitaBlue mt-8 w-full">
                            حفظ
                        </Button>
                    </div>
                </div>
